...
7. 将遥控器上的档杆SWB拨至中间位置，开始控制AutoPilot移动建图
...
8. 完成建图后，打开桌面的 **sh** 文件夹，然后在文件夹内右键选择 **open terminal**。接着，输入命令 ``bash r300_cartographer_map_save.sh`` 保存地图。
   ...
   .. note::
       - 该脚本将地图默认保存在 /home/amov/amovcar/src/AutoPilot/r300_function/maps/ 下。地图的默认名称为 r300_map
...
AutoPilot的功能包里面提供了一个简单的Cartographer纯激光建图的Demo，其bag文件放在 ``/home/amov/amovcar/src/R300/r300_function/bag/pure_slam.bag``
...
.. note::
    - 如果您AutoPilot的桌面上sh文件夹内没有相关脚本文件，请更新最新代码。代码地址见 `gitee <https://gitee.com/amovlab/amovcar/tree/v1.0-beta/>`_，选择分支为 **v1.0-beta**
